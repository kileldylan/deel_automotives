        ...
        <>
            ...
            <Box sx={{ padding: 5, backgroundColor: '#f5f5f5' }}>
                ...
                <Typography paragraph>
                    Welcome to Wahome Automotive. These Terms and Conditions govern your use of our services and website. By accessing or using our services, you agree to comply with these terms. If you do not agree, please do not use our services.
                </Typography>

                <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold' }}>2. Services Offered</Typography>
                <Typography paragraph>
                    Wahome Automotive provides a range of services, including:
                    <ul>
                ...
                <Typography paragraph>
                    ...
                    <ul>
                        ...
                        <li>Follow all safety instructions provided by Wahome Automotive staff.</li>
                    </ul>
                </Typography>
                ...
                <Typography paragraph>
                    You may cancel or reschedule your appointment up to 24 hours in advance without any charge. Cancellations made less than 24 hours prior may incur a cancellation fee, as determined by Wahome Automotive.
                </Typography>

                <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold' }}>6. Limitation of Liability</Typography>
                <Typography paragraph>
                    Wahome Automotive shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of our services. In any case, our liability will not exceed the total fees paid for the services rendered.
                </Typography>

                <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold' }}>7. Changes to Terms</Typography>
                <Typography paragraph>
                    Wahome Automotive reserves the right to update or modify these Terms and Conditions at any time. Changes will take effect immediately upon posting on our website. Your continued use of our services after any changes indicates your acceptance of the new terms.
                </Typography>
                ...
                <Typography paragraph>
                    For any questions regarding these Terms and Conditions, please contact us at <a href="mailto:support@wahomeautomotive.com">support@wahomeautomotive.com</a>.
                </Typography>
            </Box>
            <Footer />
        </>
